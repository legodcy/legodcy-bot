...
PLANS = {
    ...
    "v10m": {"title": "📦 حجمی 10G | چندکاربره (+۳۵٪)", "price": 135_000},
    "v20m": {"title": "📦 حجمی 20G | چندکاربره (+۳۵٪)", "price": 216_000},
}
...
WELCOME_TEXT = (
    ...
    "🎁 پیش از خرید، ۱۳ دقیقه تست رایگان داری — کافیه به ادمین پیام بدی: "
    f"{ADMIN_CONTACT}\n\n"
